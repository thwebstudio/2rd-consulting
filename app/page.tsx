  ...
  const services = [
    {
      ...
      description:
        "Comprehensive assistance for work permits and study visa applications worldwide.",
    ...
    },
    {
      ...
      description:
        "End-to-end corporate mobility solutions for businesses managing global talent.",
    ...
    },
    {
      ...
      description:
        "Expert guidance for permanent residency and citizenship applications.",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-right">
              <p className="text-lg text-slate-600 mb-6 max-w-md ml-auto">
                Get a free consultation in under 2 minutes. Experience peace of
                mind with our professional immigration services.
              </p>
              <Button
                size="lg"
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              We take great pride in our reputation as industry leaders,
              consistently delivering top-tier services that exceed
              expectations.
            </p>
          </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Comprehensive immigration and mobility services tailored to your
              needs
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate-600">
              We help you travel the world with our visa services
            </p>
          </div>
      ...
      <section className="py-16 bg-gradient-to-r from-amber-500 to-amber-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Let our experienced team guide you through the visa application
            process. Contact us today for a consultation.
          </p>
