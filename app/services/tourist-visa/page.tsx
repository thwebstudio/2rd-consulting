  ...
  const processSteps = [
    {
      ...
      description:
        "We help you plan your itinerary, book accommodations, and prepare travel documentation.",
      duration: "3-5 days",
    },
    {
      step: 2,
      ...
      description:
        "Comprehensive preparation of all required documents and application forms.",
      duration: "1-2 weeks",
    },
    {
      step: 3,
      ...
      description:
        "Professional submission of your tourist visa application and embassy appointment booking.",
      duration: "1-3 days",
    },
    {
      step: 4,
      ...
      description:
        "Pre-travel briefing, travel insurance, and 24/7 support during your trip.",
      duration: "Ongoing",
    },
  ];
    ...
    <div className="min-h-screen">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-right">
              <p className="text-lg text-slate-600 mb-6 max-w-md ml-auto">
                Professional tourist visa services for leisure, business, and
                family visits. We make your travel dreams come true.
              </p>
              <Button
                size="lg"
      ...
      <section className="py-16 bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-4">
              Our Tourist Visa Process
            </h2>
            <p className="text-xl text-slate-600">
              From planning to passport stamping
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-lg text-slate-600 mb-8">
                Essential documents for tourist visa applications. Requirements
                may vary by destination and purpose of visit.
              </p>
      ...
      <section className="py-16 bg-gradient-to-r from-amber-500 to-amber-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Let us handle your tourist visa application while you plan your
            perfect trip. Contact us today to get started.
          </p>
